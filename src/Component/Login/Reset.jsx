        ...
        <div className="min-h-screen  sm:flex sm:flex-row  justify-center bg-white p-5 ">
          ...
          <div className="flex justify-center self-center  z-10">
            <div className="p-12 bg-gray-800 mx-auto rounded-3xl w-96 ">
              <div className="mb-7">
                <h3 className="font-semibold text-2xl text-gray-100">Reset </h3>
              </div>
              <div className="space-y-6">
                <div className="">
                  <input
                    className=" w-full text-sm text-white px-4 py-3 bg-gray-900 border  border-gray-700 rounded-lg focus:outline-none focus:border-white"
                    type=""
                    placeholder="Email"
                  />
                </div>
